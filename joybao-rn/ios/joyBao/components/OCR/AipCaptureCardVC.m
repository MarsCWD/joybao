...
- (IBAction)turnLight:(id)sender {//闪光灯
...
- (IBAction)pressTransform:(id)sender {//底部中间图片旋转按钮
...
- (IBAction)captureIDCard:(id)sender {//拍照按钮
...
- (IBAction)pressBackButton:(id)sender {//返回按钮
    [self dismissViewControllerAnimated:YES completion:nil];
}

- (IBAction)openPhotoAlbum:(id)sender {//打开相册
